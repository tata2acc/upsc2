...
<div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <button type="button" class="btn btn-square btn-info m-4" onclick="window.location='home.php'"><i  class="fa fa-home"></i></button>
                    ...
                    <div class="card">
                        ...
                        <form method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea type="text" class="form-control" name="d_remark"></textarea>
                                    </div>
                                </div>
...
if (isset($_POST['submit'])) {
  ...
  $d_idemp = $_SESSION['ses_id'];

// คำสั่ง SQL สำหรับการ INSERT ข้อมูลใหม่
$sql_insert = "INSERT INTO `devices`(`d_id`, `d_upsname`, `d_model`, `d_company`, `d_token`, `d_location`, `d_remark`, `d_record`, `d_idemp`) VALUES
             (NULL, '$d_upsname', '$d_model', '$d_company','$d_token', '$d_location','$d_remark', CURRENT_TIMESTAMP, '$d_idemp')";
//var_dump($sql_insert);
